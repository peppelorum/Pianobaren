...
sp = spotipy.Spotify(auth_manager=SpotifyClientCredentials(client_id="b67053ce0a7d4990acac4d0c935b0776",client_secret="49626db34dbc4ed4836a270ca332f7c6"))
...
for song in a:
    ...
    subprocess.Popen('osascript -e "tell application \\"Spotify\\"" -e "play track \\"'+ songId +'\\"" -e "end tell"', shell=True, stdout=subprocess.PIPE).stdout.read()
    time.sleep(.300)
    subprocess.Popen('osascript -e "tell application \\"Spotify\\" to pause"', shell=True, stdout=subprocess.PIPE).stdout.read()
    time.sleep(.300)
    ...
    subprocess.Popen('osascript -e "tell application \\"Spotify\\" to play"', shell=True, stdout=subprocess.PIPE).stdout.read()
    time.sleep(1)
